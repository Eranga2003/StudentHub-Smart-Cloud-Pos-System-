    ...
    <header className="sticky top-0 lg:top-3.5 z-30 h-16 bg-white/95 backdrop-blur-md border-b border-slate-200/80 lg:border lg:border-slate-200/90 lg:rounded-2xl px-4 lg:px-6 flex items-center justify-between shadow-xs mb-4 lg:mb-5 transition-all">
      ...
      <div className="flex items-center gap-3 lg:gap-4 flex-1 max-w-xl">
        <button
          ...
          className="p-2 rounded-lg text-slate-600 hover:text-[#0B3B60] hover:bg-slate-100 lg:hidden"
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <img src="/logo.png" alt="StudentHub" className="w-7 h-7 object-contain" />
        </div>
        ...
        <div className="relative w-full max-w-md">
          ...
          <input
            type="text"
            placeholder="Search items, barcodes, student IDs, or invoices... (Press /)"
            className="w-full pl-9 pr-4 py-1.5 text-sm bg-slate-50 border border-slate-200 rounded-lg text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0B3B60]/20 focus:border-[#0B3B60] transition-all"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 lg:gap-4">
        ...
        <button
          ...
          className="relative p-2 rounded-lg text-slate-600 hover:text-[#0B3B60] hover:bg-slate-100 transition-colors"
          title="View Notifications"
        >
          <Bell className="w-5 h-5" />
          <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-[#43B02A] ring-2 ring-white"></span>
        </button>
